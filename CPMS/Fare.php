...
// Fetch data from the set_fare table
$sql = "SELECT * FROM set_fare";
...
<head>
  ...
  <title>Fare - Car Parking Management System</title>
  <!-- Bootstrap CSS -->
    ...
    <tbody>
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr><td>" . $row["vehicle_type"] . "</td><td>$" . $row["fare"] . "</td></tr>";
          }
      } else {
